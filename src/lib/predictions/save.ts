 ...
 *
 * Ако SELECT-ът не върне ред (мачът не съществува или прозорецът е затворен),
 * ON CONFLICT изобщо не се стига — нищо не се променя.
 */
